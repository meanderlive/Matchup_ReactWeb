...
const MemberDetails = () => {
  ...
  return (
    <Fragment>
      ...
      <PageHeader
      //  title={"Member Single Page"} curPage={"Member Single"}
      />
                                    ...
                                    <div className="post-content">
                                      ...
                                      <div className="post-description">
                                        <p>
                                          ...
                                          info create empowerment before with
                                      ...
                                      <div className="post-description">
                                        ...
                                        <div className="post-desc-img">
                                          <div className="row g-3">
                                            ...
                                            <div className="col-md-6">
                                              <img
                                                src="assets/images/group/single/02.jpg"
                                                alt="dating thumb"
                                              />
                                            </div>
                                          </div>
                                    ...
                                    <div className="post-content">
                                      <div className="post-author pb-3">
                                        <div className="post-author-inner">
                                          <div className="author-thumb">
                                            <img
                                              src="assets/images/member/home2/01.jpg"
                                              alt="datting thumb"
                                            />
                                          </div>
                                          <div className="author-details">
                                            <h6>
                                              <a href="#">David Baecker</a>
                                            </h6>
                                            <ul className="post-status">
                                              <li className="post-privacy">
                                                <i className="icofont-world"></i>{" "}
