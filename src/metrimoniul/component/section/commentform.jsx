...
class CommentForm extends Component {
  ...
  handleSubmit = (e) => {
    e.preventDefault();
    const { respondName, respondEmail, respondSubject, respondMessage } =
      this.state;
    const errors = {};
    let hasErrors = false;
        ...
        <div className="add-comment">
          <form onSubmit={this.handleSubmit} className="comment-form">
            <input
              ...
              onChange={(e) => {
                this.setState({ respondName: e.target.value });
              }}
            ...
            <input
              ...
              onChange={(e) => {
                this.setState({ respondEmail: e.target.value });
              }}
            ...
            <input
              ...
              onChange={(e) => {
                this.setState({ respondSubject: e.target.value });
              }}
            ...
            <textarea
              ...
              onChange={(e) => {
                this.setState({ respondMessage: e.target.value });
              }}
...
// Provide a safe default so submitting doesn't crash if parent doesn't pass onSubmit
