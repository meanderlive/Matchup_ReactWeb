...
const BlogContentListThree = [
  {
    ...
    desc: "In a world where screens have become our windows to the world, the concept of metrimonial has undergone a significant transformation. The evolution of technology has given birth to a new realm of relationships – one that thrives in the digital landscape. Let's embark on a captivating journey into the world of virtual metrimonial, where pixels meet hearts, and connections transcend physical boundaries. ",
    btnText: "read more",
    pubDate: "10 May 2023",
  ...
  },
  {
    ...
    desc: "Navigating the world of online metrimonial is like exploring uncharted territory.Online metrimonial is a powerful tool, a gateway to meeting individuals who might otherwise remain outside our social circles. Yet, it's vital to balance the allure of new connections with safety and caution. Using Google image search or reverse phone number searches can provide additional information about someone you've connected with online.",
    btnText: "read more",
    pubDate: "15 May 2023",
  ...
  },
  {
    ...
    desc: "In the quest for love, navigating the intricacies of metrimonial can be both exhilarating and nerve-wracking. As a seasoned matchmaker, I've witnessed numerous metrimonial scenarios and identified common mistakes that can significantly impact your chances of finding lasting love.",
    btnText: "read more",
  ...
  },
  {
    ...
    desc: "In the realm of online metrimonial, hope intermingles with skepticism, creating a delicate balance between optimism and caution. For many, this digital landscape becomes a paradox of opportunities and challenges, a place where quality connections await those who tread carefully.",
    btnText: "read more",
                  ...
                  <div className="blog__item">
                    <div className="blog__inner d-flex flex-wrap align-items-center">
                      <div className="blog__thumb w-xl-50 w-100">
                        <Link to="/metrimonial/blog/User/blogDetails">
                          <img
                            src={`${val.imgUrl}`}
                            alt={`${val.imgAlt}`}
                            className="w-100"
                      ...
                      <div className="blog__content p-4 ps-xl-5 w-xl-50 w-100">
                        ...
                        <p>{val.desc}</p>
                        <Link
                          to="/metrimonial/blog/User/blogDetails"
